...
class _SuggestedDeckListState extends ConsumerState<SuggestedDeckList> {
  ...
  void _onScroll() async {
    if (_scrollController.position.pixels >=
      ...
      await ref.read(homeViewModelProvider.notifier).loadMoreSuggestedDecks();
    }
  }
        ...
        children: [
          ...
          ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final entry = suggestedDecks[index];
              ...
              //   did: 'did',
              //   uid: 'uid',
              //   name: 'Từ điển Việt Anh',
              //   description: 'Bộ từ điển Việt Anh hay nhất',
              //   totalCards: 101,
