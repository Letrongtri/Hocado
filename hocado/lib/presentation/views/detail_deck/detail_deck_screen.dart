...
// class DetailDeckScreen extends ConsumerStatefulWidget {
//   final String deckId;
//   const DetailDeckScreen({super.key, required this.deckId});

//   @override
//   ConsumerState<DetailDeckScreen> createState() => _DetailDeckScreenState();
// }

// class _DetailDeckScreenState extends ConsumerState<DetailDeckScreen> {
//   // @override
//   // void initState() {
//   //   super.initState();
//   //   Future.microtask(() {
//   //     ref
//   //         .read(detailDeckViewModelProvider.notifier)
//   //         .getDeckDetails(widget.deckId);
//   //   });
//   // }
...
//     // Chỉ fetch 1 lần thôi, tránh gọi nhiều khi rebuild
//     ref
//         .read(detailDeckViewModelProvider.notifier)
//         .getDeckDetails(widget.deckId);
//   }
...
//     final asyncState = ref.watch(detailDeckViewModelProvider);

//     return Scaffold(
//       appBar: asyncState.hasValue
//           ? _buildMainAppBar(
//               theme,
//               context,
//               () {},
...
//               () {},
//             )
//           : _buildMainAppBar(theme, context, null, null, null),
...
//             onRefresh: () => ref
//                 .read(detailDeckViewModelProvider.notifier)
//                 .refreshDeckDetails(widget.deckId),
