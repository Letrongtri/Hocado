...
class SearchViewModel extends AsyncNotifier<SearchState> {
  ...
  Future<void> refresh() async {
    ...
    try {
      final uid = _currentUser?.uid ?? '';
      final query = currentState.currentSearchQuery;
      final tabIndex = currentState.currentTabIndex;
      ...
      switch (tabIndex) {
        case 0: // Public Decks
          final result = await _repo.searchDecks(
            ...
            isFindingPublic: true,
            search: query,
            lastDocument: null, // Reset pagination về đầu
            limit: _limit,
          );
          ...
          state = AsyncValue.data(
            currentState.copyWith(
              ...
              publicDecksLastDocument: result.lastDocument,
              publicDecksHasMore: result.decks.length == _limit,
            ),
          );
          break;
        ...
        case 1: // My Decks
          ...
          state = AsyncValue.data(
            currentState.copyWith(
              myDecks: result.decks,
              myDecksLastDocument: result.lastDocument,
              myDecksHasMore: result.decks.length == _limit,
            ),
          );
          break;
      }
