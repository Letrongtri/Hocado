...
class LearningActivitiesList extends StatelessWidget {
  ...
  Icon? _getIcon(String type) {
    ...
    } else if (type == LearningActivityType.createdDeck.name) {
      return Icon(Icons.save, color: AppColors.notLearnedColorFg);
    }
    return null;
  }
  ...
  String _getSubtitle(LearningActivity activity) {
    ...
    } else if (activity.type == LearningActivityType.savedDeck.name) {
      return "Đã lưu bộ thẻ mới";
    }
    return "";
  }
